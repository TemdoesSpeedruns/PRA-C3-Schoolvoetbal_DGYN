<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('results')"
                :active="request()->routeIs('results')">Uitslagen</x-responsive-nav-link>
            <x-responsive-nav-link :href="route('historie')" :active="request()->routeIs('historie')">Vorige
                Winnaars</x-responsive-nav-link>
        </div>
